...
embedding_matrix = rng.standard_normal(size=(embedding_dim, extrinsic_dim))
...
if __name__ == "__main__":
    ...
    if embed_data:
        ...
        observed_dim = embedding_dim
    else:
        observed_dim = extrinsic_dim
    ...
    ae_ref = AutoEncoder(observed_dim, intrinsic_dim, hidden_dims, encoder_act, decoder_act, final_act=final_act)
    ...
    for name, weights in weight_configs.items():
        ...
        ae = AutoEncoder(observed_dim, intrinsic_dim, hidden_dims, encoder_act, decoder_act,
                         final_act=final_act)
