...
class ImplicitManifoldNetwork(nn.Module):
    ...
    # TODO: this assumes the co-dim is one, does it not? We should review this.
...
if __name__ == "__main__":
    ...
    hyp = ImplicitManifoldNetwork(neurons, activation).to(device)
